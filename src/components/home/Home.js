      ...
      <main className="w-full h-full py-12 px-4 flex justify-center">
        <div className="w-full max-w-2xl flex flex-col text-primary-text">
          ...
          <div className="flex flex-wrap gap-4 justify-around items-center mb-6">
            <Button
              className="bg-blue-600 cursor-pointer p-2 rounded text-gray-100"
            ...
            />
            <Button
              className="bg-red-400 cursor-pointer p-2 rounded text-gray-100"
              title="Clear Text"
              onClick={() => dispatch({ type: "clear" })}
              text={state.text}
            />
            <Button
              className="bg-green-600 cursor-pointer p-2 rounded text-gray-100"
          ...
          <div>
            ...
            <textarea
              className="h-40 w-full bg-gray-100 outline-none border-none cursor-not-allowed"
              value={state.text}
              readOnly
            ></textarea>
          </div>
